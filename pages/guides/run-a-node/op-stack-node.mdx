...
Activate the `Enable external nodes` setting. **Note**: If you wish to disable this setting later, please contact our [Support](https://conduitxyz.typeform.com/to/kGF2oAj1#source=website).

...
1. Select the network you want to run and set `CONDUIT_NETWORK` env variable. You will need to know the `slug` of the network, which you can find in the Conduit app by going to the [*Browse rollups* page](https://app.conduit.xyz/browse-networks) and clicking `Run a node` for the network you want to run. 

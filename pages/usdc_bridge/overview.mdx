...
- USDC can be bridged to all supported blockchain networks that are integrated with CCTP directly without withdrawing to the settelement layer
...
> TODO: Will this adress address be the same for all rollup?

The bridged USDC Token will have the following properties:

- Name: `Bridged USDC (YOUR_ROLLUP_NAME)`
- Symbol: `USDC.e`
- Decimals: `6`
- Bridged USDC Address: TBD

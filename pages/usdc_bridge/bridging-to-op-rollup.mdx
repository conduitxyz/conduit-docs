...
| Settlement Layer | SETTLEMENT USDC TOKEN ADDRESS                | SETTLEMENT_USDC_BRIDGE_ADDRESS               | SETTLEMENT_RPC_URL                  |
| ---------------- | -------------------------------------------- | -------------------------------------------- | ----------------------------------- |
...
For a detailed overview of how the USDC bridge functions on Optimism, you can explore the official repository here: [Bridged USDC Standard for the OP Stack](https://github.com/defi-wonderland/opUSDC).

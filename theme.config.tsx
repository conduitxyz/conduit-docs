...
const config: DocsThemeConfig = {
  ...
  logo: (
    <svg fill="none" height="auto" viewBox="0 0 745 194" width="120">
      ...
      />
      <path
        d="M159.3 136.208L189.033 84.6168L160.471 84.6168L130.738 136.208L159.3 136.208Z"
        fill="currentColor"
        opacity="0.4"
      />
      <path
        d="M64.4446 138.941L81.5349 168.598L94.8325 191.669L109.113 166.888L78.7258 114.162L64.4446 138.941Z"
        fill="currentColor"
        opacity="0.7"
      />
      <path
        d="M112.077 165.175L204.942 165.175L175.752 114.52L161.282 139.63L126.787 139.607L110.839 112.443L81.6897 112.443L112.077 165.175Z"
        fill="currentColor"
      />
      <path
        d="M112.077 168.596L97.7913 193.382L190.657 193.382L204.942 168.596L112.077 168.596Z"
        fill="currentColor"
        opacity="0.4"
      />
      <path
        d="M130.14 82.9086L113.801 110.734L127.765 134.516L157.508 82.9071L111.075 2.33458L81.8847 52.9893L112.574 52.9893L130.14 82.9086Z"
        fill="currentColor"
        opacity="0.7"
      />
      <path
        d="M189.033 81.1955L142.598 0.618091L114.035 0.618089L160.483 81.1955L189.033 81.1955Z"
        fill="currentColor"
      />
      <path
        d="M125.168 81.1955L110.616 56.4096L49.3962 56.4096L63.6796 81.1955L125.168 81.1955Z"
        fill="currentColor"
      />
      <path
        d="M46.435 58.1226L-0.000268679 138.695L14.2707 163.459L60.7061 82.8866L46.435 58.1226Z"
        fill="currentColor"
        opacity="0.7"
      />
      <path
        d="M77.7352 109.023L110.836 109.023L125.165 84.6192L63.6796 84.6192L17.2321 165.177L75.6126 165.177L60.4956 138.943L77.7352 109.023Z"
        fill="currentColor"
        opacity="0.4"
      />
    </svg>
